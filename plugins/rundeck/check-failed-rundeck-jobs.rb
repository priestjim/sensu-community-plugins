#!/usr/bin/env ruby
#
# Checks for failed Rundeck jobs in a specified interval
# ===
#
# DESCRIPTION:
#   This plugin checks for failed Rundeck jobs
#
# OUTPUT:
#   plain-text
#
...
#
# curl -v -H 'Accept: application/json' -H 'Content-Type: application/json' 'http://localhost:4440/api/11/executions.json?project=AWS_Snapshots&statusFilter=failed&recentFilter=4d&authtoken=3Mt8sbkuTavwophrvVfxOmC7HBTutYfF'
